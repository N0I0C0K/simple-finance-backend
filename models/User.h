...
class User
{
  public:
    ...
    /**  For column lastDealTime  */
    ///Get the value of the column lastDealTime, returns the default value if the column is null
    const uint64_t &getValueOfLastdealtime() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
