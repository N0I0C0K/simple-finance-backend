...
class Record
{
  public:
    ...
    const std::string &getValueOfFromuserid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getFromuserid() const noexcept;
    ...
    const std::string &getValueOfTouserid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getTouserid() const noexcept;
    ///Set the value of the column toUserId
    void setTouserid(const std::string &pTouserid) noexcept;
    ...
    const uint64_t &getValueOfDealtime() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
